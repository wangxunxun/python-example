...
#        desired_caps['deviceName'] = 'Android Emulator'
    ...
    def entersettingpage(self):
        ...
        sleep(5)
        self.findelementbyclassnameindex('android.widget.ImageView', 4, 'setting').click()
...
if __name__ == '__main__':
    ...
    test = unittest.TestLoader().loadTestsFromName('botaiautotest.setting.test_personalinformation')
